...
# Инструкция часть 1 (работа с Git)
...
# **Заключительная цитата по Git и GitHub.**
...
>Наш фокус — снять все барьеры и дать возможность сразу начать работать над конкретным мобильным приложением, роботом или любым другим проектом. Мы хотели сделать возможным открытие своего проекта для любого человека в мире — и сделали.
