...
## Эта команда позволяет склонировать c удалённого репозиторий на наш ПК:

    * git clone  ссылка на репозиторий из гитхаба

   Пример:  git clone https://github.com/maxim-stoma/gitHomeWork.git 
   
   ## Чтобы отправить изменение в удалённый репозитория на гитхаб команда:
    
    *  git push
   
   ## Чтобы скачать актуальную версию проекта с гита :
    * команда git pull
