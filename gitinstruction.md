# These are common Git commands used in various Situation: 

![gitComnd.png](gitComond.png)

*we can understand why git* 

![whyGit.png](whyGit.png)
...
* git switch
 ...
 _**here we can see my conflict thin merge**_ 
 ![conflict.png](conflict.png)
   

_in the end_:  
you can have more informations about Git commonds from this side
...
================================== 
# *работо с удалёнными репозиториями, pull request* 
...
для более подробный информаций можно посмотрит на сайт: 
