...
Затем после коммита отправить изменения в репозиторий:
>`git push -u origin master`

### Получение изменений из удалённого репозитория 
 Для того чтобы автоматически получить изменения из удалённой ветки и слить их со своей текущей, следует использовать команду: 
 >`git pull`
