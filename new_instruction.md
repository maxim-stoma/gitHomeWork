...
## Создание локальной копии удаленного репозитория (fork, push)

* Создать папку на рабочем столе (локально)

* Открыть папку в VSC. Убедиться,что нет репозитория, для этого вызываем команду *git status*

* Далее выполнить команду *git clone https//...* (Fork-репозитория)

* Выполнить команду *cd <название удаленного репозитория>*, где будем работать, изменять, добавлять информацию.

* Далее выполнить команду *git push https//...*
...
## Создание локальной копии удаленного репозитория (fork, pull)

* Создать папку на рабочем столе (локально)

* Открыть папку в VSC. Создать репозиторий, для этого вызываем команду *git init*

* Далее выполнить команду *git pull https//...* (Fork-репозитория)
...
* После добавления измененного файла на Github, появляется *compare and pull request*, нажимаем эту кнопку и открывается окно на заполнения стандартных пунктов это комментарии к изменениям, открыть новую ветку с обсуждением отправляемого кода и автора оригинального проекта