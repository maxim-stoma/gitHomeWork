...
Git - это универсальный редактор, позволяющий сохранять изменения с комментариями автора и вести сразу несколько вариантов проекта или нескольких частей одного проекта параллельно.
