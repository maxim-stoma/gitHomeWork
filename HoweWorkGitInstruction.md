...
![CreateRepoStep1](Pictures/CreateRepoStep1.png)

Затем жмем на зеленую кнопочку "New" и попадаем на страницу создания удаленного репозитория. Что же здесь происходит?
...
На Quick setup не обращаем внимания, так как нас интересуют 2 серых окошка. Что же в них происходит? В двух словах - авторизация гита.
...
>Кстати иногда можно встретиться с такой ситуацией, что после команды "git push" git выдаст нам ошибку. Тут не стоит пугаться, нужно всего лишь последовать подсказки гита и прописать команду "git push" но только с небольшими нюансами. А с какими именно, познакомитесь на практике (:
...
1. Нам понадобится получить от друга ссылка на его удаленный репозиотрий, либо же найти на просторах гитхаба любой другой удаленный репозиторий. 
![Friend'sRemoteRepo](Pictures/Friend'sRemoteRepo.png)
