...
*После того как мы запушим изменения, GitHub предложит нам сделать Merge Request, если мы хотим поделиться с автором репозитория нашей работой, то мы можем этим возпользоваться.*
